...
Overview
This project showcases automated testing of web applications using Selenium WebDriver with Java. It employs the Page Object Model (POM) design pattern for maintaining a clear separation between test code and page-specific code.
...
Download the jar and open using any IDE(Intellij)
